...
const BannerContent = () => {
  return (
    <section className="flex flex-col items-center justify-center text-center md:text-left md:items-start px-4  py-12 bg-gradient-to-r  min-h-[70vh]">
      {/* Main Heading */}
      <h1 className="text-4xl md:text-5xl font-bold tracking-wide leading-tight text-primary">
